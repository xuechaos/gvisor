...
type Tchannel struct {
	...
	// Control indicates the channel control ID. In the current
	// implementation, this is either zero, which indicates the data
	// channel, or one, which indicates the control channel.
	Control uint32
}
